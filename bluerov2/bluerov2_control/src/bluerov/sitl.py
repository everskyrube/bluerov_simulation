    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            try:
                ...
                q1 = [pose['orientation']['w'], pose['orientation']['z'], pose['orientation']['x'], pose['orientation']['y']]

                # Apply a full 180-degree flip around the Z-axis instead of X-axis
                q2 = self.quaternion_from_axis([0, 0, 1], math.pi)
